...
export default function Landing() {
	return (
		<div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(99,102,241,0.09),_transparent_35%),_linear-gradient(180deg,_#f8faf9_0%,_#f5f7fb_100%)] text-foreground">
			...
			<section className="relative overflow-hidden">
				...
				<div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-6 pt-16 pb-20 text-center md:pt-20 lg:pt-24">
					<div className="max-w-3xl">
						<div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-white/80 px-3 py-1.5 text-xs font-medium text-emerald-900 shadow-sm backdrop-blur">
						...
						<div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground">
							<div className="flex items-center gap-2 rounded-full border border-border bg-white/80 px-3 py-1.5">
					...
					<div className="relative w-full max-w-208">
						<div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-primary/15 via-violet-400/10 to-emerald-400/20 blur-2xl" />
						<div className="relative rounded-[2rem] border border-border/80 bg-white/80 p-4 shadow-[0_30px_80px_rgba(15,23,42,0.08)] backdrop-blur-lg">
							<div className="rounded-[1.5rem] border border-border bg-[#f7faf8] p-4 md:p-5">
			...
			<section
				id="features"
				className="scroll-mt-32 border-t border-border/60 bg-white/60 py-24"
			>
				<div className="mx-auto max-w-6xl px-6">
					...
					<div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
						{featureItems.map((feature) => (
							<div
								key={feature.title}
								className="group rounded-3xl border border-border bg-white p-6 shadow-[0_18px_40px_rgba(15,23,42,0.03)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(79,184,178,0.12)]"
							>
			...
			<section
				id="testimonials"
				className="scroll-mt-32 border-t border-border/60 bg-[#f5f7fb] py-24"
			>
				<div className="mx-auto max-w-5xl px-6">
					...
					<div className="mt-12 grid gap-6 md:grid-cols-3">
						{testimonials.map((item) => (
							<blockquote
								key={item.n}
								className="rounded-3xl border border-border bg-white p-6 shadow-[0_18px_40px_rgba(15,23,42,0.03)]"
							>
			...
			<section className="py-24">
				<div className="mx-auto max-w-4xl rounded-[2rem] border border-border bg-gradient-to-r from-primary/10 via-violet-500/8 to-emerald-500/10 p-8 text-center shadow-[0_24px_70px_rgba(15,23,42,0.05)] md:p-12">
					<div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-white/70 px-3 py-1.5 text-xs font-medium text-emerald-800">
			...
			<footer className="border-t border-border/60 bg-white/40 py-10 text-center text-sm text-muted-foreground">
